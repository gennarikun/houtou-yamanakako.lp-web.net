<footer class="section siteFooter">
		<div class="footerMenu">
			<div class="container">
				<nav class="menu-menu-container">
					<ul id="menu-menu-1" class="menu nav">
						<li id="menu-item-2029"
							class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2029"><a
								href="/contact/">お申込み・アクセス</a></li>
						<li id="menu-item-2473"
							class="menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-2473">
		...
		<div class="container sectionBox copySection text-center">
			<p>Copyright © 山中湖の体験教室【富士家】｜ ほうとう・そば・吉田のうどん｜友達同士・家族も大歓迎 All Rights Reserved.</p>
			<p>Powered by <a href="https://wordpress.org/">WordPress</a> &amp; <a href="https://lightning.nagoya/ja/"
					target="_blank" title="Free WordPress Theme Lightning"> Lightning Theme</a> by Vektor,Inc.
				technology.</p>
		</div>
	</footer>
<div id="vk-mobile-nav-menu-btn" class="vk-mobile-nav-menu-btn">MENU</div>
	<div class="vk-mobile-nav vk-mobile-nav-drop-in" id="vk-mobile-nav">
		<nav class="vk-mobile-nav-menu-outer" role="navigation">
			<ul id="menu-menu-2" class="vk-menu-acc menu">
				<li
					class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-2029">
					<a href="/contact/">お申込み・アクセス</a>
					<ul class="sub-menu">
				...
				<li
					class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-2473">
					...
					<ul class="sub-menu">
						...
						<li id="menu-item-3565"
							class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3565">
							<a href="/" aria-current="page">山梨県プレミアム体験プラン</a></li>
					</ul>
				</li>
				<li class="menu-item menu-item-type-post_type menu-item-object-page"><a
						href="/dantai/">団体ランチ</a></li>
				...
				<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2025"><a
						href="/gallery/">体験ギャラリーページ</a></li>
				<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2023"><a
						href="/sponsor/">富士家スポンサー様</a></li>
				<li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2610"><a
						href="/about-suridane/">お土産すりだね紹介</a></li>
			</ul>
		</nav>
	</div>