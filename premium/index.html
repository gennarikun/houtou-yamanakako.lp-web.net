...
<head>
	...
	<title>【山梨県プレミアムほうとう体験プラン】甲州ワインビーフ・カニ・釜飯・季節のデザート・甲州ワインの豪華なセット – 山中湖の体験教室【富士家】｜ ほうとう・そば・吉田のうどん｜友達同士・家族も大歓迎</title>
	<meta name="robots" content="max-image-preview:large">

	<script type="text/javascript" src="//webfonts.xserver.jp/js/xserverv3.js?fadein=0&amp;ver=2.0.9"
		id="typesquare_std-js"></script>
...
<body class="wp-singular page-template-default page page-id-3543 wp-theme-lightning fa_v7_css bootstrap4 device-pc">
			...
			<div class="row">
				<div class="col-md-12">
					<h1 class="page-header_pageTitle">
						【山梨県プレミアムほうとう体験プラン】甲州ワインビーフ・カニ・釜飯・季節のデザート・甲州ワインの豪華なセット</h1>
				</div>
			</div>
		</div>
	</div><!-- [ /.page-header ] -->
			...
			<div class="row">
				<ol class="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
					<li id="panHome" itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem"><a
							itemprop="item" href="../"><span itemprop="name"><i class="fa-solid fa-house"></i>
								HOME</span></a>
						<meta itemprop="position" content="1">
					</li>
					<li><span>【山梨県プレミアムほうとう体験プラン】甲州ワインビーフ・カニ・釜飯・季節のデザート・甲州ワインの豪華なセット</span>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col mainSection mainSection-col-one" id="main" role="main">
					<article id="post-3543" class="entry entry-full post-3543 page type-page status-publish hentry">
								...
								<header class="lp-hero">
									...
									<div class="lp-hero-inner">
										<h1 class="lp-hero-copy"><span class="lp-hero-sub-text">富士家の贅沢体験プラン。</span><span
												class="lp-hero-main-text">山梨・日本</span><span
												class="lp-hero-main-text">の美食を<br class="sp-only">極める</span></h1>
									...
									<div class="lp-container">
										...
										<div class="lp-card lp-card-special">
											...
											<div class="lp-card-image"><img fetchpriority="high" decoding="async"
													...
													src="../assets/1753328133583-1024x768-1.jpg" alt="甲州ワインビーフほうとう"
										...
										<div class="lp-grid-2col">
													...
													<div class="lp-plan-item">
														<div class="lp-plan-head"><span class="lp-plan-badge">Plan
															...
															<img loading="lazy" decoding="async"
																class="aligncenter size-full"
																src="../assets/Ni5g_3v2.jpg" alt="" width="1280"
																height="855"><br>
											...
											<!-- ▼ プレミアム体験コース -->
											<div class="lp-card">
												<div class="lp-card-image"><img decoding="async" src="../assets/1.png"
														alt="プレミアム体験コース"></div>
												<div class="lp-card-body">
									...
									<div class="lp-container">
										<div class="lp-cta-box">
											...
											<div class="lp-cta-actions"><a class="lp-btn lp-btn-web"
													href="../contact/"><br>
													<span class="lp-btn-sub">ご予約・お問い合わせはこちら</span><br>
													<span class="lp-btn-main">お問い合わせフォーム</span><br>
												</a></div>
										</div>
									</div>
								</section>
									...
									<div class="lp-container">
										...
										<div class="lp-faq-grid">
											...
											<div class="lp-faq-item">
												...
												<p class="lp-faq-a">A. 河口湖店・甲府店のいずれでもご予約いただけます。</p>
											</div>
										</div>
									</div>
								</section>
				...
				<div class="col-md-12 ">
					<aside class="widget widget_text" id="text-7">
						<div class="textwidget">
								...
								<div class="veu_contact">
									<section class="veu_contact veu_contentAddSection">
										<div class="contact_frame">
											<p class="contact_txt"><span class="contact_txt_tel veu_color_txt_key">お申込み
													<i class="fa fa-arrow-circle-o-right"></i></span><span
													class="contact_txt_time">24時間受け付けております</span></p>
											<p><a class="btn btn-primary btn-lg contact_bt" href="../contact/"><span
														class="contact_bt_txt">お問い合わせもこちら </span><span
														class="contact_bt_subTxt">お気軽にご相談ください</span></a></p>
										</div>
									</section>
								</div>
							</div>
							...
							<p>予めご了承くださいませ。</p>
							<h3>富士家 富士吉田河口湖店</h3>
							<p><img loading="lazy" decoding="async" class="aligncenter size-large wp-image-2954"
									src="../assets/DSC04855-1024x683.jpg" alt="ほうとう体験教室" width="1024" height="683"></p>
								...
								<tbody>
									...
									<tr>
										...
										<td style="text-align: left;">
											予約優先性（不定休で営業しておりますので、確実にご利用になりたいという方は前日までのご予約をお願い致します。）</td>
									</tr>
									<tr>
							...
							<p><iframe loading="lazy" style="border: 0;"
									src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12993.89572309672!2d138.75915296977539!3d35.4925577!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6019674bbfeed92b%3A0xe1f4a8a8bebf3fb7!2z44G744GG44Go44GG5L2c44KK5L2T6aiT5pWZ5a6k5a-M5aOr5a62!5e0!3m2!1sja!2sjp!4v1620652675063!5m2!1sja!2sjp"
									allowfullscreen="allowfullscreen"></iframe></p>
							<h3>富士家 甲府店</h3>
							<p><img loading="lazy" decoding="async" src="../assets/unnamed-1024x771.png" alt="富士家 甲府店"
									width="1024" height="771" class="aligncenter size-large wp-image-6551"></p>
							<table style="margin-bottom: 20px;">
								<tbody>
									<tr>
										<td style="background-color: #eee; width: 20%;">住所</td>
							...
							<p><iframe loading="lazy" style="border: 0;"
									src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3241.9971410603234!2d138.57254497608224!3d35.65244207259652!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x601bf9ebb5cfa1cb%3A0x1b7dafda328d64dc!2z44Oq44OD44OB44OA44Kk44Ok44Oi44Oz44OJ57eP5ZCI5biC5rCR5Lya6aSo!5e0!3m2!1sja!2sjp!4v1746377353099!5m2!1sja!2sjp"
